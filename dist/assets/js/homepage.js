...
__webpack_require__(/*! ./plugins/site-message/init-site-message */ "./src/assets/js/plugins/site-message/init-site-message.js"); //hgy lazy
...
/***/ "./src/assets/js/plugins/site-message/init-site-message.js":
/*!*****************************************************************!*\
  !*** ./src/assets/js/plugins/site-message/init-site-message.js ***!
  \*****************************************************************/
/*! no static exports found */
...
jQuery.fn.extend({
  ulsterSiteMessage: function ulsterSiteMessage(apiURL, domain) {
    var api = apiURL; //default message
    ...
    function addBanner(markup) {
      ...
      var html = markup; //markup should include close button.
    ...
    function initSiteMsgDismiss() {
      ...
      if (jQuery('#dismiss').length > 0) {
        ...
        var setCookieDomain = domain; //const setCookieDomain = 'localhost';
