...
/***/ "./src/assets/js/plugins/breadcrumb-style/init.js":
/*!********************************************************!*\
  !*** ./src/assets/js/plugins/breadcrumb-style/init.js ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ulsBreadcrumbInit": function() { return /* binding */ ulsBreadcrumbInit; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ulsterCookieConsentInit": function() { return /* binding */ ulsterCookieConsentInit; }
/* harmony export */ });
/*
  ...
  jQuery.fn.extend({
    ulsterCookieConsent: function ulsterCookieConsent(domain) {
      ...
      if (consentCookie) {
        ...
        jQuery('body').append('<div id="uls_cc" role="region" aria-label="cookie banner" class="action-sheet opacity-effect">' + '<div class="grid-container">' + '<div class="grid-x grid-margin-x dark-grey-bg m-b-10 m-small-b-0 p-t-10 p-b-10 shadow">' + '<div class="cell small-11 medium-10 large-10 position-relative">' + '<p class="text-white m-b-0 flt-small-l vertical-align">' + domain + ' uses cookies to give users the best experience possible.  <a href="https://www.ulster.ac.uk/about/cookies" class="bl text-white">Find out more<span class="show-for-sr"> about our use of cookies</span></a></p>' + '</div>' + '<div class="cell small-1 medium-2 large-2">' + '<ul class="m-b-0 flt-r m-l-20 m-small-l-0 m-small-t-0">' + '<li class="text-right"><a href="#" class="button small hollow white expanded flt-r" id="uls_cc_close"><span class="fas fa-times-circle" aria-hidden="true"></span><span class="hide-for-small-only">&nbsp;Dismiss</span></a></li>' + '</ul>' + '</div>' + '</div>' + '</div>' + '</div>'); //set cookie
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "jqueryCookieInit": function() { return /* binding */ jqueryCookieInit; }
/* harmony export */ });
  ...
  !function (t, e, n) {
    ...
    if (t.console = t.console || {
      ...
      var a = {
        ...
        onActivate: n.noop,
        onDeactivate: n.noop,
        clickContent: function clickContent(t) {
        ...
        mobile: {
          ...
          clickSlide: function clickSlide(t) {
            return "image" === t.type ? "toggleControls" : "close";
          },
          dblclickContent: function dblclickContent(t) {
            return "image" === t.type && "zoom";
          },
          dblclickSlide: function dblclickSlide(t) {
            return "image" === t.type && "zoom";
          }
        },
        lang: "en",
      ...
      n.extend(b.prototype, {
        ...
        addEvents: function addEvents() {
          ...
          }), e.group[e.currIndex].opts.idleTime && (e.idleSecondsCounter = 0, r.on("mousemove.fb-idle mouseleave.fb-idle mousedown.fb-idle touchstart.fb-idle touchmove.fb-idle scroll.fb-idle keydown.fb-idle", function () {
        ...
        setIframe: function setIframe(t) {
          var e,
              ...
              i = t.opts.iframe,
              a = t.$slide;
          t.$content = n('<div class="fancybox-content' + (i.preload ? " fancybox-is-hidden" : "") + '"></div>').css(i.css).appendTo(a), a.addClass("fancybox-slide--" + t.contentType), t.$iframe = e = n(i.tpl.replace(/\{rnd\}/g, new Date().getTime())).attr(i.attr).appendTo(t.$content), i.preload ? (o.showLoading(t), e.on("load.fb error.fb", function () {
    ...
    d.prototype.destroy = function () {
      ...
      e.canTap = !1, e.newWidth = p, e.newHeight = h, e.contentLastPos = {
        top: d + (b + x),
        left: l + (g + y),
        scaleX: f,
        scaleY: f
    ...
    e.extend(n.prototype, {
      ...
      "afterShow.fb": function afterShowFb(t, e) {
        var o = e && e.SlideShow;
        o && o.isActive && o.set();
      },
...
/***/ "./src/assets/js/plugins/hqy-lazy/hqy-lazyload.js":
/*!********************************************************!*\
  !*** ./src/assets/js/plugins/hqy-lazy/hqy-lazyload.js ***!
  \********************************************************/
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "hqyLazyInit": function() { return /* binding */ hqyLazyInit; },
/* harmony export */   "ulsLazyLoadInit": function() { return /* binding */ ulsLazyLoadInit; }
/* harmony export */ });
/* module decorator */ module = __webpack_require__.hmd(module);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function (obj) { return typeof obj; }; } else { _typeof = function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function hqyLazyInit() {
  ...
  __namespace__('./dom.js', function (__include__, exports) {
    ...
    exports.contains = function (parentEl, el, _undef) {
      ...
      while (prEl && prEl != _undef) {
        // _undef 在这里是 undefined 的值
  ...
  __namespace__('./index.js', function (__include__, exports, module) {
    ...
    module.exports = HqyLazyload; // device pixel ratio
    ...
    Utils.assign(HqyLazyload.prototype, loadElement, {
      ...
      initContext: function initContext() {
        ...
        saveViewportOffset(context.viewport, options.offset); // handle multi-served image src (obsolete)
      ...
      render: function render() {
        var options = this.options;
        var context = this.context; // First we create an array of elements to lazy load

        context.elements = Dom.toElements(options.elements); // Then we bind resize and scroll events if not already binded
      ...
      validate: function validate() {
        ...
        Utils.each(elements, function (ele) {
          if (Dom.hasClass(ele, context.loadingClass) || Dom.hasClass(ele, options.successClass) || Dom.hasClass(ele, options.errorClass)) {
            count--;
            return;
          }
      ...
      elementInView: function elementInView(ele) {
        var options = this.options;
        var context = this.context;
        var viewport = context.viewport;
        var container = context.container;
        var rect = ele.getBoundingClientRect(); // Is element inside a container?

        if (Dom.container && Dom.contains(container, ele)) {
          var containerRect = container.getBoundingClientRect(); // Is container in view?
      ...
      load: function load(elements, force) {
        var context = this.context;
  ...
  __namespace__('./loadElement.js', function (__include__, exports, module) {
    ...
    function process(el, dataSrc, options, context) {
      ...
      var isPicture = parent && Dom.equal(parent, 'picture'); // An item with src like iframe, unity games, simpel video etc
    ...
    module.exports = {
      handleSourceElement: function handleSourceElement(el, attr, dataAttr) {
      ...
      handleSrcsetElement: function handleSrcsetElement(el, src, srcset) {
        if (srcset) {
      ...
      loadElementSuccess: function loadElementSuccess(el) {
        var options = this.options;
        Dom.addClass(el, options.successClass);
        Dom.removeClass(el, options.loadingClass);
        if (options.success) options.success(el);
      },
      loadElementError: function loadElementError(el, msg) {
        var options = this.options;
        if (options.error) options.error(el, msg);
        Dom.addClass(el, options.errorClass);
        Dom.removeClass(el, options.loadingClass);
      },
      loadElement: function loadElement(el, force) {
        var options = this.options;
        var context = this.context;
        this; // if element is visible, not loaded or forced
        ...
        if (force || options.loadInvisible || el.offsetWidth > 0 && el.offsetHeight > 0) {
          ...
          if (dataSrc) {
            process.call(this, el, dataSrc, options, context); // video and others
          } else {
            Dom.addClass(el, options.loadingClass); // video with child source
  ...
  __namespace__('./utils.js', function (__include__, exports) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setLastSearch": function() { return /* binding */ setLastSearch; }
/* harmony export */ });
/*
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ulsMegaMenuInit": function() { return /* binding */ ulsMegaMenuInit; }
/* harmony export */ });
...
/* harmony import */ var foundation_sites_js_foundation_equalizer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! foundation-sites/js/foundation.equalizer */ "./node_modules/foundation-sites/js/foundation.equalizer.js");
/* harmony import */ var foundation_sites_js_foundation_toggler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! foundation-sites/js/foundation.toggler */ "./node_modules/foundation-sites/js/foundation.toggler.js");
/* harmony import */ var foundation_sites_js_foundation_tabs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! foundation-sites/js/foundation.tabs */ "./node_modules/foundation-sites/js/foundation.tabs.js");
/* harmony import */ var _plugins_cookie_init__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./plugins/cookie/init */ "./src/assets/js/plugins/cookie/init.js");
/* harmony import */ var _plugins_hqy_lazy_hqy_lazyload__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./plugins/hqy-lazy/hqy-lazyload */ "./src/assets/js/plugins/hqy-lazy/hqy-lazyload.js");
/* harmony import */ var _plugins_last_search_init__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./plugins/last-search/init */ "./src/assets/js/plugins/last-search/init.js");
/* harmony import */ var _plugins_cookie_consent_init__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./plugins/cookie-consent/init */ "./src/assets/js/plugins/cookie-consent/init.js");
/* harmony import */ var _plugins_megamenu_init__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./plugins/megamenu/init */ "./src/assets/js/plugins/megamenu/init.js");
/* harmony import */ var _plugins_breadcrumb_style_init__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./plugins/breadcrumb-style/init */ "./src/assets/js/plugins/breadcrumb-style/init.js");
/* harmony import */ var _plugins_fancybox_dist__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./plugins/fancybox/dist */ "./src/assets/js/plugins/fancybox/dist.js");
...
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__.Foundation.plugin(foundation_sites_js_foundation_offcanvas__WEBPACK_IMPORTED_MODULE_2__.OffCanvas, 'OffCanvas');
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__.Foundation.plugin(foundation_sites_js_foundation_equalizer__WEBPACK_IMPORTED_MODULE_3__.Equalizer, 'Equalizer');
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__.Foundation.plugin(foundation_sites_js_foundation_toggler__WEBPACK_IMPORTED_MODULE_4__.Toggler, 'Toggler');
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__.Foundation.plugin(foundation_sites_js_foundation_tabs__WEBPACK_IMPORTED_MODULE_5__.Tabs, 'Tabs');
...
(0,_plugins_cookie_init__WEBPACK_IMPORTED_MODULE_6__.jqueryCookieInit)(); //initSiteMessage('https://www.ulster.ac.uk/_web_services/site-message/all-pages/_nocache', 'ulster.ac.uk');
//initSiteMsgDismiss();

(0,_plugins_cookie_consent_init__WEBPACK_IMPORTED_MODULE_9__.ulsterCookieConsentInit)();
(0,_plugins_hqy_lazy_hqy_lazyload__WEBPACK_IMPORTED_MODULE_7__.hqyLazyInit)();
(0,_plugins_hqy_lazy_hqy_lazyload__WEBPACK_IMPORTED_MODULE_7__.ulsLazyLoadInit)();
(0,_plugins_breadcrumb_style_init__WEBPACK_IMPORTED_MODULE_11__.ulsBreadcrumbInit)();
(0,_plugins_fancybox_dist__WEBPACK_IMPORTED_MODULE_12__.fancyBox)();
(0,_plugins_fancybox_dist__WEBPACK_IMPORTED_MODULE_12__.fancyBoxInit)(); //ulsCourseMobTabs();

(0,_plugins_megamenu_init__WEBPACK_IMPORTED_MODULE_10__.ulsMegaMenuInit)();
}();
/******/ })()
;
