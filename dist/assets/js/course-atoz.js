...
/***/ "./node_modules/tinysort/dist/tinysort.js":
/*!************************************************!*\
  !*** ./node_modules/tinysort/dist/tinysort.js ***!
  \************************************************/
/*! no static exports found */
...
(function (root, tinysort) {
  ...
  if (true) {
    !(__WEBPACK_AMD_DEFINE_FACTORY__ = (singleton),
  ...
  function tinysort(nodeList, options) {
    ...
    function addCriterium(options) {
      ...
      criteria.push(extend({
        ...
        hasData: allOptions.data !== nll // filter
        ,
        hasFilter: hasFilter,
    ...
    function sortFunction(a, b) {
      ...
      while (sortReturnNumber === 0 && criteriumIndex < numCriteria) {
        ...
        if (criterium.sortFunction) {
          ...
          // regular sort
          var isNumeric = fls // prepare sort elements
          ,
      ...
      if (sortReturnNumber === 0) sortReturnNumber = a.pos > b.pos ? 1 : -1; //console.log('sfn',a.pos,b.pos,valueA,valueB,sortReturnNumber); // todo: remove log;
    ...
    function applyToDOM() {
      ...
      if (isSameParent && hasSortedAll) {
        if (isFlex) {
          ...
          if (parentNode) parentNode.appendChild(sortedIntoFragment());else console.warn('parentNode has been removed');
        }
      } else {
        var criterium = criteria[0],
    ...
    function getSortBy(elementObject, criterium) {
      var sortBy,
          element = elementObject.elm; // element
      ...
      if (criterium.hasAttr) sortBy = element.getAttribute(criterium.attr);else if (criterium.useVal) sortBy = element.value || element.getAttribute('value');else if (criterium.hasData) sortBy = element.getAttribute('data-' + criterium.data);else if (element) sortBy = element.textContent; // strings should be ordered in lowercase (unless specified)
  ...
  win.Element && function (ElementPrototype) {
    ElementPrototype.matchesSelector = ElementPrototype.matchesSelector || ElementPrototype.mozMatchesSelector || ElementPrototype.msMatchesSelector || ElementPrototype.oMatchesSelector || ElementPrototype.webkitMatchesSelector || function (selector) {
      var that = this,
          nodes = (that.parentNode || that.document).querySelectorAll(selector),
          i = -1; //jscs:disable requireCurlyBraces
  ...
  }(Element.prototype); // extend the plugin to expose stuff
...
__webpack_require__(/*! ./api/youtube/init */ "./src/assets/js/api/youtube/init.js"); //require('./api/clickforassistance/init');
...
__webpack_require__(/*! ./plugins/course-finder/atoz/init */ "./src/assets/js/plugins/course-finder/atoz/init.js"); //hgy lazy
...
/***/ "./src/assets/js/plugins/course-finder/atoz/init.js":
/*!**********************************************************!*\
  !*** ./src/assets/js/plugins/course-finder/atoz/init.js ***!
  \**********************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var tinysort__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tinysort */ "./node_modules/tinysort/dist/tinysort.js");
/* harmony import */ var tinysort__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(tinysort__WEBPACK_IMPORTED_MODULE_0__);
...
jQuery(document).ready(function () {
  function coursesAlphabetical() {
    jQuery('.courses-az').each(function () {
      ...
      tinysort__WEBPACK_IMPORTED_MODULE_0___default()('.page_letters div', {
        attr: 'data-letter'
      });
    });
  }
...
/***/ 10:
/*!********************************************!*\
  !*** multi ./src/assets/js/course-atoz.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/ulster-frontend-beta/src/assets/js/course-atoz.js */"./src/assets/js/course-atoz.js");


/***/ })

/******/ });
//# sourceMappingURL=course-atoz.js.map