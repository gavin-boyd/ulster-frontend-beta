...
/*
   Function: ulsterVideoPromo

   This plugin adds a YouTube video background.
...
_jquery2.default.fn.extend({
	ulsterVideoPromo: function ulsterVideoPromo() {

		if (navigator.userAgent.match(/(iPod|iPhone|iPad)/)) {
			//debug
			//console.log('I am an iPad');
			(0, _jquery2.default)(this).each(function () {
				var videoID = (0, _jquery2.default)(this).data('video-id');
				var imageURL = 'http://img.youtube.com/vi/' + videoID + '/maxresdefault.jpg';
				(0, _jquery2.default)(this).parent('.video-promo').backstretch(imageURL);
			});
		} else {
			//debug
			//console.log('I am NOT an iPad');
			//change made to test memory leak - 26/01/17
			(0, _jquery2.default)(this).each(function () {
				var src = (0, _jquery2.default)(this).data('video-id');
				...
				function onPlayerStateChange(playerState, thisItem, videoID) {
					if (playerState.data == 0) {
						//if video has finished
						var leakCleanup = function leakCleanup(thisItem) {
							var frameList, i, j, len;
							frameList = thisItem;
							for (j = 0, len = frameList.length; j < len; j++) {
								i = frameList[j];
								i.contentWindow.location.href = "about:blank";
							}
							return frameList.remove();
						};
						//apply youtube picture as a background


						var videoID = (0, _jquery2.default)(playerState.target.a).data('video-id');
						var imageURL = 'http://img.youtube.com/vi/' + videoID + '/maxresdefault.jpg';
						(0, _jquery2.default)(playerState.target.a).parent('.video-promo').backstretch(imageURL);
						//remove the player
						leakCleanup((0, _jquery2.default)(playerState.target.a));
						(0, _jquery2.default)(playerState.target.a).remove();
					}
				}

				//init
				onYouTubeIframeAPIReady(id, src, width, height, container);
			});
		}
	}
});
...
/*
   Function: ulsterResponsiveVideo

   This function makes any youtube fit its parent, without black frame borders.  To only be used on video promos in conjunction with ulsterVideoPromo
...
*/
_jquery2.default.fn.extend({
	ulsterResponsiveVideo: function ulsterResponsiveVideo() {
		//debug
		//console.log('responsive video');
		var windowWidth = (0, _jquery2.default)(window).width();
		(0, _jquery2.default)(this).each(function () {
			var containerHeight = (0, _jquery2.default)(this).parents('div.video-promo').height();
			containerHeight = containerHeight * 2.2;
			containerHeight = containerHeight + 'px';
			var containerWidth = (0, _jquery2.default)(this).parents('div.video-promo').width();
			if (windowWidth < 340) {
				containerWidth = containerWidth * 5;
				//debug
				//console.log('is small mobile '+ containerWidth);
			} else if (windowWidth < 460) {
				containerWidth = containerWidth * 4;
				//debug
				//console.log('is mobile '+ containerWidth);
			} else if (windowWidth < 690) {
				containerWidth = containerWidth * 3;
				//debug
				//console.log('is tablet '+ containerWidth);
			} else {
				containerWidth = containerWidth * 2;
				//debug
				//console.log('is desktop '+ containerWidth);
			}
			containerWidth = containerWidth + 'px';
			var containerWidthOriginal = (0, _jquery2.default)(this).parents('div.video-promo').width();
			containerWidthOriginal = containerWidthOriginal / 2;
			containerWidthOriginal = containerWidthOriginal + 'px';
			var containerHeightOriginal = (0, _jquery2.default)(this).parents('div.video-promo').height();
			containerHeightOriginal = containerHeightOriginal / 2;
			containerHeightOriginal = containerHeightOriginal + 'px';
			(0, _jquery2.default)(this).css('height', containerHeight);
			(0, _jquery2.default)(this).css('width', containerWidth);
			(0, _jquery2.default)(this).css('left', '-' + containerWidthOriginal);
			(0, _jquery2.default)(this).css('top', '-' + containerHeightOriginal);
		});
	}
});
...
*/
_jquery2.default.fn.extend({
	ulsterPopup: function ulsterPopup() {
		(0, _jquery2.default)(this).each(function () {
			var videoID = (0, _jquery2.default)(this).data('video-id');
			...
			function leakCleanup() {
				var frameList, i, j, len;
				frameList = (0, _jquery2.default)('iframe.mfp-iframe');
				for (j = 0, len = frameList.length; j < len; j++) {
					i = frameList[j];
					i.contentWindow.location.href = "about:blank";
				}
...
(0, _jquery2.default)(window).on('load', function () {
	if ((0, _jquery2.default)('.ulstervideopromo').length !== 0) {
		(0, _jquery2.default)('.ulstervideopromo').ulsterVideoPromo();
		(0, _jquery2.default)('.video-promo iframe.video').ulsterResponsiveVideo();
	}
});
(0, _jquery2.default)(document).ready(function () {

	if ((0, _jquery2.default)('a.ulsterpopup').length !== 0) {
		console.log('init video');
		(0, _jquery2.default)('a.ulsterpopup').ulsterPopup();
	}
});
