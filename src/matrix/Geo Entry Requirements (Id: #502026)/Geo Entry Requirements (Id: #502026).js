...
if (res &&  countryCode !== '') {
  ...
  for (i = 0; i < res.length; i++) {
    if (res[i].country_code == countryCode) {
      ...
      output += '<h2 class="h2">';
      output += '<img src="//cdn.ulster.ac.uk/home/ulster-frontend/beta/assets/img/svg-country-flags/' + countryCode.toLowerCase() + '.svg" alt="' + name + ' flag" class="thumbnail m-r-10" width="60" />';
