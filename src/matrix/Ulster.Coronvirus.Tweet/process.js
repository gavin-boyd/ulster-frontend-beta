...
if (json) {
  ...
  for (var i = 0; i < tweets.length; i++) {
    ...
    output += '<a href="' + url + '" class="display-block bg-core-blue p-l-15 p-r-15 p-t-10 p-b-10 text-white bl m-b-20" style="background-color:#1C8DEE!important;" target="_blank">';
