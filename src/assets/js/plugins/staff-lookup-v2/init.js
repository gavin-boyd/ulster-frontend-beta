...
jQuery('#person-search').submit(function(e) {
  jQuery("#results").load("https://www.ulster.ac.uk/_web_services/people/lookup?query=" + encodeURIComponent(jQuery("#person-query").val()), function( response, status, xhr ) {initPersonButtons();});
  e.preventDefault();
});
