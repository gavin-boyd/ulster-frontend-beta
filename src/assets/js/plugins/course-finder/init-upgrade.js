...
function courseFinderInit(frontendURL) {
  jQuery(document).ready(function ($) {
    ...
    function olpAjaxCourseSearch() {
      ...
      function generateSearchURL() {
        if (jQuery('#query').val() !== '') {
          var searchURL = frontendURL + '?query=' + jQuery('#query').val();
        } else {
          var searchURL = frontendURL + '?query=' + jQuery('#query').val();
        }
...
export {mobileFacets, setLastSearch, removeModalElements, sortTheFacets, showMobileMenu, courseFinderInit};
