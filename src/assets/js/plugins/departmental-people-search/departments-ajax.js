jQuery(document).ready(function() {
  ...
  function ajaxRequest(searchURL, pushState) {
      ...
      if (!('history' in window) || !('pushState' in history)) {
        ...
        jQuery('#content-view').prepend('<div class="preloader-container"><div class="preloader"><span class="hide">Loading search results</span> <img src="https://cdn.ulster.ac.uk/home/ulster-frontend/beta/assets/img/ulster-pre-loader.gif" width="169" height="169" alt="Loading results"/></div></div>');
      }
  }
