...
//countdown clock for homepage
//see js fiddle: https://codepen.io/ParsonsProjects/pen/mVbZgY

/*var moment = require('moment');
var countdown = require('countdown');
require('moment-countdown');
setInterval(function(){
  var time = moment().countdown("2019-09-01", countdown.MONTHS|countdown.WEEKS|countdown.DAYS|countdown.HOURS|countdown.MINUTES|countdown.SECONDS, NaN, 0).toHTML('div').replace(/,/g, '').replace("and", '');
  jQuery('#clock').html(time);
}, 1000);*/

//https://www.w3schools.com/howto/howto_js_countdown.asp
// Set the date we're counting down to
var countDownDate = new Date("Sep 17, 2019 00:00:00").getTime();
