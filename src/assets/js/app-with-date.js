...
//additional js
require('./plugins/date-picker/legacy.js');
require('./plugins/date-picker/picker.js');
require('./plugins/date-picker/picker.date.js');
require('./plugins/date-picker/picker.time.js');
require('./plugins/date-picker/init.js');
