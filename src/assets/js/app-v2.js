...
import isotopeInit from './plugins/isotope/init';

//sticky video
import stickyVideoInit from './plugins/stickyvideo/init';

//hqy-lazyload - import not working
//require('hqy-lazyload');
//import HqyLazyload from 'hqy-lazyload';
//import hqyLazyInit from './plugins/hqy-lazy/init';
